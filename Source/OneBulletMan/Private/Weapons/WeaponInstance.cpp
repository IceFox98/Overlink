...
void AWeaponInstance::ToggleWeaponPhysics(bool bEnable)
{
	if (bEnable)
	{
...
void AWeaponInstance::OnWeaponHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
