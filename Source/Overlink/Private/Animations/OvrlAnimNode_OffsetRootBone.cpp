...
#include UE_INLINE_GENERATED_CPP_BY_NAME(OvrlAnimNode_OffsetRootBone)
...
namespace Ovrl::Anim::OffsetRootBone
{
...
void FOvrlAnimNode_OffsetRootBone::GatherDebugData(FNodeDebugData& DebugData)
{
...
void FOvrlAnimNode_OffsetRootBone::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
...
void FOvrlAnimNode_OffsetRootBone::CacheBones_AnyThread(const FAnimationCacheBonesContext& Context)
{
	Super::CacheBones_AnyThread(Context);
	Source.CacheBones(Context);
}

void FOvrlAnimNode_OffsetRootBone::Update_AnyThread(const FAnimationUpdateContext& Context)
{
	...
	UE::Anim::TScopedGraphMessage<Ovrl::AnimationWarping::FRootOffsetProvider> ScopedMessage(Context, FTransform(SimulatedRotation, SimulatedTranslation));

	Source.Update(Context);
}

void FOvrlAnimNode_OffsetRootBone::Evaluate_AnyThread(FPoseContext& Output)
{
	...
	bool bShouldConsumeTranslationOffset = Ovrl::Anim::OffsetRootBone::ShouldExtractRootMotion(CurrentTranslationMode);
	bool bShouldConsumeRotationOffset = Ovrl::Anim::OffsetRootBone::ShouldExtractRootMotion(CurrentRotationMode);
	...
	if (Ovrl::Anim::OffsetRootBone::ShouldCounterComponentDelta(CurrentRotationMode))
	{
	...
	if (Ovrl::Anim::OffsetRootBone::ShouldCounterComponentDelta(CurrentTranslationMode))
	{
	    ...
	    GetTranslationMode() == EOffsetRootBoneMode::Interpolate)
	{
		...
		const float DampenAlpha = Ovrl::Anim::OffsetRootBone::DamperImplicit(GetTranslationHalflife(), CachedDeltaTime);
	    ...
	    GetRotationMode() == EOffsetRootBoneMode::Interpolate)
	{
		...
		const float DampenAlpha = Ovrl::Anim::OffsetRootBone::DamperImplicit(GetRotationHalfLife(), CachedDeltaTime);
	...
	if (GetMaxRotationError() >= 0.0f)
	{
		...
		if (FMath::Abs(OffsetAngle) > MaxAngleRadians)
		{
			...
			// SimulatedRotation = RotationOffset * ComponentTransform.GetRotation(); // -- Original line
			SimulatedRotation = ComponentTransform.GetRotation() * RotationOffset; // Computes rotation around the local axis, instead of the world
...
EWarpingEvaluationMode FOvrlAnimNode_OffsetRootBone::GetEvaluationMode() const
{
	return GET_ANIM_NODE_DATA(EWarpingEvaluationMode, EvaluationMode);
}

bool FOvrlAnimNode_OffsetRootBone::GetResetEveryFrame() const
{
	return GET_ANIM_NODE_DATA(bool, bResetEveryFrame);
}

bool FOvrlAnimNode_OffsetRootBone::GetOnGround() const
{
	return GET_ANIM_NODE_DATA(bool, bOnGround);
}

const FVector& FOvrlAnimNode_OffsetRootBone::GetGroundNormal() const
{
	return GET_ANIM_NODE_DATA(FVector, GroundNormal);
}

const FVector& FOvrlAnimNode_OffsetRootBone::GetTranslationDelta() const
{
	return GET_ANIM_NODE_DATA(FVector, TranslationDelta);
}

const FRotator& FOvrlAnimNode_OffsetRootBone::GetRotationDelta() const
{
	return GET_ANIM_NODE_DATA(FRotator, RotationDelta);
}

EOffsetRootBoneMode FOvrlAnimNode_OffsetRootBone::GetTranslationMode() const
{
	return GET_ANIM_NODE_DATA(EOffsetRootBoneMode, TranslationMode);
}

EOffsetRootBoneMode FOvrlAnimNode_OffsetRootBone::GetRotationMode() const
{
	return GET_ANIM_NODE_DATA(EOffsetRootBoneMode, RotationMode);
}

float FOvrlAnimNode_OffsetRootBone::GetTranslationHalflife() const
{
	return GET_ANIM_NODE_DATA(float, TranslationHalflife);
}

float FOvrlAnimNode_OffsetRootBone::GetRotationHalfLife() const
{
	return GET_ANIM_NODE_DATA(float, RotationHalfLife);
}

float FOvrlAnimNode_OffsetRootBone::GetMaxTranslationError() const
{
	return GET_ANIM_NODE_DATA(float, MaxTranslationError);
}

float FOvrlAnimNode_OffsetRootBone::GetMaxRotationError() const
{
	return GET_ANIM_NODE_DATA(float, MaxRotationError);
}

bool FOvrlAnimNode_OffsetRootBone::GetClampToTranslationVelocity() const
{
	return GET_ANIM_NODE_DATA(bool, bClampToTranslationVelocity);
}

bool FOvrlAnimNode_OffsetRootBone::GetClampToRotationVelocity() const
{
	return GET_ANIM_NODE_DATA(bool, bClampToRotationVelocity);
}

float FOvrlAnimNode_OffsetRootBone::GetTranslationSpeedRatio() const
{
	return GET_ANIM_NODE_DATA(float, TranslationSpeedRatio);
}

float FOvrlAnimNode_OffsetRootBone::GetRotationSpeedRatio() const
{
	return GET_ANIM_NODE_DATA(float, RotationSpeedRatio);
}

EOffsetRootBone_CollisionTestingMode FOvrlAnimNode_OffsetRootBone::GetCollisionTestingMode() const
{
	return GET_ANIM_NODE_DATA(EOffsetRootBone_CollisionTestingMode, CollisionTestingMode);
}

float FOvrlAnimNode_OffsetRootBone::GetCollisionTestShapeRadius() const
{
	return GET_ANIM_NODE_DATA(float, CollisionTestShapeRadius);
}

const FVector& FOvrlAnimNode_OffsetRootBone::GetCollisionTestShapeOffset() const
{
	return GET_ANIM_NODE_DATA(FVector, CollisionTestShapeOffset);
}

void FOvrlAnimNode_OffsetRootBone::Reset(const FAnimationBaseContext& Context)
{
